...
class OriginalListAndCopy:
    ...
    # def toggle_reference_list(self.original_is_reference)-> bool:
    #     return not self.original_is_reference
...
def merge_Sort(Original_and_copy: OriginalListAndCopy, array_info: SubList) -> None:
    ...
    if (Original_and_copy.list_length < 2) or ((array_info.end - array_info.start + 1) < 2):
        return 
