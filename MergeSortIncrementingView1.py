...
def merge(Original_and_copy: OriginalListAndCopy, parent_sub: SubList, l_sub: SubList, r_sub: SubList) -> OriginalListAndCopy:
>>>>>>> parent of b2110fd (Merge sort is working without having two switch statements by returning the boolean in the merge function and starting the boolean as false)
    l_index = l_sub.start
    r_index = r_sub.start
